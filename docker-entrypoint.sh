...
#DEPLOYMENT_COMMAND_OPTIONS="--context staging" #unkonw tag --context, same as --host
DEPLOYMENT_COMMAND_OPTIONS="ssh://$INPUT_REMOTE_DOCKER_HOST:$INPUT_SSH_PORT"
echo "Command: DOCKER_HOST=${DEPLOYMENT_COMMAND_OPTIONS} COMPOSE_PROJECT_NAME=reco4thingin_srv ${DEPLOYMENT_COMMAND} ${INPUT_ARGS}"
DOCKER_HOST=${DEPLOYMENT_COMMAND_OPTIONS} COMPOSE_PROJECT_NAME=reco4thingin_srv ${DEPLOYMENT_COMMAND} ${INPUT_ARGS}
